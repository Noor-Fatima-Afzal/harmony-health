          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" defaultValue="sarah.johnson@medcore.com" />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Receive email updates for appointments</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Always notify for critical patient conditions</p>
                </div>
                <Switch defaultChecked />
              </div>
            </CardContent>
